...
- **Async human intervention** — Agents escalate via built-in intervention issues (`HUMAN:` / `human-escalation`) when they need human input; step in at your convenience
